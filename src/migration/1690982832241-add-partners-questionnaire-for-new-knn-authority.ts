...
} from './data/1690982832241-add-partners-questionnaire-for-new-knn-authority/questionnaireKnnPartners';


export class AddPartnerQuestionnaireForNewKnnAuthority1690982832241 implements MigrationInterface {
