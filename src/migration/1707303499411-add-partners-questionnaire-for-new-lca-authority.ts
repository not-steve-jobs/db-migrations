...
} from './data/1707303499411-add-partners-questionnaire-for-new-lca-authority/questionnaireLcaPartners';

export class AddPartnerQuestionnaireForNewLcaAuthority1707303499411 implements MigrationInterface {
