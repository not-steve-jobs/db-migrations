...
export class AlterConfiguratorTables1692021876896 implements MigrationInterface {
  name = 'AlterConfiguratorTables1692021876896';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`cp_providerMethods\` ADD \`isPaymentAccountRequired\` tinyint(1) NOT NULL DEFAULT '1'`);
    await queryRunner.query(`ALTER TABLE \`cp_providerMethods\` ADD \`isPayoutAsRefund\` tinyint(1) NOT NULL DEFAULT '0'`);
