...
export class AddConfiguratorTables1689520051405 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX \`CPPMTCUniqueProviderMethodIdCurrencyIso3TypeIdx\` ON \`cp_providerMethodTransactionsConfigs\``);
    ...
    await queryRunner.query(`DROP INDEX \`CPMBCAUniqueMethodIdCountryAuthorityId\` ON \`cp_methodsByCountryAuthority\``);
