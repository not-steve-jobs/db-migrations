export const getSelectQuestionnaireQuestionnairesQuery =
  `SELECT id FROM questionnaireQuestionnaires WHERE product ='partners' AND authority ='cri'`;
...
export const insertQuestionnaire =
  `INSERT INTO questionnaireQuestionnaires (
        ...
        'cri',  NULL, NULL, 1, NULL, 'partners', 1, NULL, 'CRI Partners Questionnaire', NULL
    )`;
