export const getSelectQuestionnaireQuestionnairesQuery =
  `SELECT id FROM questionnaireQuestionnaires WHERE product ='partners' AND authority ='knn'`;
...
export const insertQuestionnaire =
  `INSERT INTO questionnaireQuestionnaires (
        ...
        'knn',  NULL, NULL, 1, NULL, 'partners', 1, NULL, 'KNN Partners Questionnaire', NULL
    )`;
