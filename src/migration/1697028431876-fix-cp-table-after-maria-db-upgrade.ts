...
export class FixCpTableAfterMariaDbUpgrade1697028431876 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await tolerateQuery(queryRunner, `ALTER TABLE \`cp_countryAuthorityMethods\` DROP FOREIGN KEY \`fkCPMBCACountryAuthorityIdIdx\``);
    await tolerateQuery(queryRunner, `ALTER TABLE \`cp_fieldOptions\` DROP FOREIGN KEY \`fkPMFProviderMethodFieldId\``);
    await tolerateQuery(queryRunner, `ALTER TABLE \`cp_providerMethodFields\` DROP FOREIGN KEY \`fkPMProviderMethodId\``);
    ...
    await queryRunner.query('DELETE FROM `cp_countryAuthorityMethods` WHERE `countryAuthorityId` NOT IN (SELECT `id` FROM `cp_countriesAuthorities`)');
    await queryRunner.query('DELETE FROM `cp_fieldOptions` WHERE `providerMethodFieldId` NOT IN (SELECT `id` FROM `cp_providerMethodFields`)');
    await queryRunner.query('DELETE FROM `cp_fieldOptions` WHERE `providerMethodFieldId` IN ' +
    ...
    await queryRunner.query('DELETE FROM `cp_providerMethodFields` WHERE `providerMethodId` NOT IN (SELECT `id` FROM `cp_providerMethods`)');
    ...
    await queryRunner.query(`ALTER TABLE \`cp_methods\` MODIFY COLUMN createdBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_methods\` MODIFY COLUMN updatedBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providers\` MODIFY COLUMN createdBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providers\` MODIFY COLUMN updatedBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`cp_methods\` MODIFY COLUMN createdBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_methods\` MODIFY COLUMN updatedBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providers\` MODIFY COLUMN createdBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providers\` MODIFY COLUMN updatedBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providerMethods\` MODIFY COLUMN createdBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providerMethods\` MODIFY COLUMN updatedBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providerMethodFields\` MODIFY COLUMN createdBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`cp_providerMethodFields\` MODIFY COLUMN updatedBy varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL`);
  }
}
