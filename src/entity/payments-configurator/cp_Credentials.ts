...
@Index('CPСUniqueProviderAuthorityCountryCurrencyIdx', ['providerCode', 'authorityFullCode', 'countryIso2', 'currencyIso3'], { unique: true })
...
export class cp_Credentials {
  ...
  @JoinColumn([{ name: 'providerCode', referencedColumnName: 'code', foreignKeyConstraintName: 'fkCPCProviderCodeIdx' }])
  public provider: cp_Providers;

  @ManyToOne(() => cp_Authorities, { onDelete: 'RESTRICT', onUpdate: 'CASCADE', nullable: true })
  @JoinColumn([{ name: 'authorityFullCode', referencedColumnName: 'fullCode', foreignKeyConstraintName: 'fkCPCAuthorityFullCodeIdx' }])
  ...
  @JoinColumn([{ name: 'currencyIso3', referencedColumnName: 'iso3', foreignKeyConstraintName: 'fkCPCCurrencyIso3Idx' }])
