...
@Index('CPPFUniqueProviderCountryAuthorityCurrencyIdx', ['providerCode', 'countryIso2', 'authorityFullCode', 'currencyIso3'], { unique: true })
...
export class cp_ProviderFields {
  ...
  @JoinColumn([{ name: 'providerCode', referencedColumnName: 'code', foreignKeyConstraintName: 'fkCPPFProviderCodeIdx' }])
  public provider: cp_Providers;

  @ManyToOne(() => cp_Authorities, { onDelete: 'RESTRICT', onUpdate: 'CASCADE', nullable: true })
  @JoinColumn([{ name: 'authorityFullCode', referencedColumnName: 'fullCode', foreignKeyConstraintName: 'fkCPPFAuthorityFullCodeIdx' }])
  ...
  @JoinColumn([{ name: 'currencyIso3', referencedColumnName: 'iso3', foreignKeyConstraintName: 'fkCPPFCurrencyIso3Idx' }])
