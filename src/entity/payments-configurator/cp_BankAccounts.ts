...
export class cp_BankAccounts {
  ...
  @JoinColumn([{ name: 'providerCode', referencedColumnName: 'code', foreignKeyConstraintName: 'fkCPBAProviderCodeIdx' }])
  public provider: cp_Providers;

  @ManyToOne(() => cp_Authorities, { onDelete: 'RESTRICT', onUpdate: 'CASCADE', nullable: true })
  @JoinColumn([{ name: 'authorityFullCode', referencedColumnName: 'fullCode', foreignKeyConstraintName: 'fkCPBAAuthorityFullCodeIdx' }])
  ...
  @JoinColumn([{ name: 'currencyIso3', referencedColumnName: 'iso3', foreignKeyConstraintName: 'fkCPBACurrencyIso3Idx' }])
