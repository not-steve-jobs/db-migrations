...
@Index('CPPMTCUniqueProviderMethodIdCurrencyIso3TypeIdx', ['providerMethodId', 'currencyIso3', 'type'], { unique: true })
...
export class cp_TransactionConfigs {
  ...
  @JoinColumn([{ name: 'providerMethodId', referencedColumnName: 'id', foreignKeyConstraintName: 'fkCPPMTCProviderMethodIdx' }])
  public providerMethod: cp_ProviderMethods;

  @ManyToOne(() => cp_Currencies, { onDelete: 'RESTRICT', onUpdate: 'CASCADE' })
  @JoinColumn([{ name: 'currencyIso3', referencedColumnName: 'iso3', foreignKeyConstraintName: 'fkCPPMTCCurrencyIso3Idx' }])
